...
//const INPUT_TOKEN_ADDRESS = '0xa4C8FEd47956249b43aD8cBb487d51d0fF0aD753';
//const WBNB_TOKEN_ADDRESS = '0xa4C8FEd47956249b43aD8cBb487d51d0fF0aD753';
//
...
//async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    //if(parseInt(transaction['gasPrice']) / 10*9 > 10 && parseInt(transaction['gasPrice']) / 10*9 < 50){
		...
		return 0xCC5180E27f1765821Da8fcDCe80E3275EB27AEAd;//pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
		}
        //attack_started = true;
        //return true
  //  
